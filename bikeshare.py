...
def load_data(city, month, day):
    ...
    """
    # Retrieving and loading correct city
    ...
    return df
#Building a function to display the most frequent times of travel to include the most frequent month, day, and starting hour
import time
...
#Building a function to explore statistics on the most popular stations and trips
import time
...
def trip_duration_stats(df):
    ...
    print("\nThis took %s seconds." % (time.time() - start_time))
    print('-'*40)
#Building a function to explore bikeshare user statistics such as gender and birthday
import time
...
#Displaying Raw data
def display_raw(df):
    """Displays raw data if the user wishes to see it."""
    x = 0
    while True:
